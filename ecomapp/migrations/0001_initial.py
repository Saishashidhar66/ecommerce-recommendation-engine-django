    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('warranty', models.CharField(blank=True, max_length=225, null=True)),
                ('return_policy', models.CharField(blank=True, max_length=225, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('payment_method', models.CharField(choices=[('Cash On Delivery', 'Cash On Delivery'), ('UPI', 'UPI'), ('NETBANKING', 'NETBANKING')], default='Cash On Delivery', max_length=20)),
